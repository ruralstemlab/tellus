...
@Component({
  ...
  template: `
    <div class="verification-container">
      ...
      <!-- Certificado Tellus V3.0 - Con diseño ajustado -->
          ...
          <div class="certificate-wrapper">
            <div class="certificate">
              ...
              <div class="cert-header">
                ...
                <!-- ===== RURAL STEAM LAB - GRANDE, CENTRADO, ARRIBA ===== -->
                <div class="org-name">
              ...
              <!-- ===== NOMBRE DEL PARTICIPANTE - MÁS PEQUEÑO Y UNA SOLA LÍNEA ===== -->
  ...
  styles: [
    `
      ...
      /* ==========================================================
         CERTIFICADO V3.0 - CON AJUSTES DE TAMAÑO
      ========================================================= */
      .certificate-preview {
        margin: 20px 0;
        display: flex;
      ...
      /* ===== NOMBRE DEL PARTICIPANTE - MÁS PEQUEÑO Y UNA SOLA LÍNEA ===== */
      .cert-student-name {
        font-size: 48px;            /* <-- MÁS PEQUEÑO QUE EL TÍTULO */
        font-weight: 400;
      ...
      @media (max-width: 850px) {
        ...
        .org-name { font-size: 1.8rem; }
        .cert-student-name { font-size: 36px; }
        .cert-project-name { font-size: 28px; }
        ...
        .cert-student-name { white-space: normal; max-width: 95%; }
      }

      @media (max-width: 600px) {
        .org-name { font-size: 1.4rem; }
        .cert-student-name { font-size: 28px; }
        .cert-project-name { font-size: 22px; }
        .cert-description { font-size: 0.75rem; }
        .recognition-text { font-size: 0.55rem; }
      }
