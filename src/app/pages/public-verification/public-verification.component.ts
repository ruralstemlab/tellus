...
@Component({
  ...
  template: `
    <div class="verification-container">
      ...
      <!-- Certificado Tellus V3.0 - Premium Edition (sin romper nada) -->
  ...
  styles: [
    `
      ...
      /* ==========================================================
         CERTIFICADO V3.0 - JERARQUÍA VISUAL CLARA (MEJORADO)
      ========================================================= */
      .certificate-preview {
        margin: 20px 0;
        display: flex;
      ...
      .tech-info {
        ...
        gap: 6px;
        z-index: 1;
        border-right: 0.8px solid rgba(200, 162, 74, 0.15);
        padding-right: 14px;
      }
      .tech-item {
        text-align: left;
      ...
      .cert-signatures {
        ...
        margin-top: auto;
        padding-top: 12px;
        border-top: 0.8px solid rgba(200, 162, 74, 0.12);
        position: relative;
        z-index: 1;
        flex-wrap: wrap;
        gap: 8px;
...
export class PublicVerificationComponent implements OnInit {
  ...
  // ================================================================
  //  MÉTODO downloadPDF (exactamente el mismo que funcionaba)
  // ================================================================
