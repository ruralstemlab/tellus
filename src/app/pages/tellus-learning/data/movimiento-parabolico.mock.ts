 ...
 * 7. Reflexión
 *
 * El ciclo es continuo y circular.
 *
 * Road to Glory:
 * - No es un momento.
 * - Es una actividad de simulación.
 * - Pertenece al momento Experimentación.
 * - Es complementaria/ opcional.
 * ============================================================
 */
...
export const MOVIMIENTO_PARABOLICO_EXPERIENCE: Experience = {
  ...
  subtitle: 'Investiga, experimenta y comprende el movimiento de los objetos en el aire.',
...
export const MOVIMIENTO_PARABOLICO_MOMENTS: Moment[] = [
...

  {
    ...
    experienceId: MOVIMIENTO_PARABOLICO_EXPERIENCE.id,
    ...
    description:
      'Observa el fenómeno y conecta el problema con situaciones de tu entorno.',
...
export const MOVIMIENTO_PARABOLICO_ACTIVITIES: Activity[] = [
...

  {
    ...
    momentId: 'moment-motivacion',

    order: 1,

    title: 'Observa el fenómeno',
...

  {
    ...
    momentId: 'moment-exploracion',

    order: 1,

    title: 'Explora la trayectoria',
    ...
    config: {
      ...
      simulatorId: 'exploracion-movimiento-parabolico',
...

  {
    ...
    momentId: 'moment-prediccion',

    order: 1,

    title: 'Formula tu predicción',
  ...
  /* ==========================================================
   * EXPERIMENTACIÓN — LABORATORIO FÍSICO
   * ========================================================== */

  {
    ...
    momentId: 'moment-experimentacion',

    order: 1,

    title: 'Laboratorio físico',
        ...
        fields: [
          {
            ...
            type: 'text',
            required: true,
            hint: 'Identifica el objeto utilizado en el lanzamiento.',
          },
...

  {
    ...
    config: {
      ...
      // No bloquea el cierre de Experimentación.
...

  {
    ...
    momentId: 'moment-construccion',

    order: 1,

    title: 'Construye tu modelo',
...

  {
    ...
    momentId: 'moment-analisis-evaluacion',
...
/* ============================================================
 * OBJETO ÚNICO DE LA EXPERIENCIA
 * ============================================================
 *
 * Facilita el trabajo durante la fase de prototipo.
 *
 * Más adelante estos datos serán reemplazados por Firestore.
 * ============================================================
 */

export const MOVIMIENTO_PARABOLICO_MOCK = {
  experience: MOVIMIENTO_PARABOLICO_EXPERIENCE,

  moments: MOVIMIENTO_PARABOLICO_MOMENTS,

  activities: MOVIMIENTO_PARABOLICO_ACTIVITIES,
};